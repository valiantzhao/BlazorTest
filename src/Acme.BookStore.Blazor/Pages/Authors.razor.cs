...
namespace Acme.BookStore.Blazor.Pages
{
    public partial class Authors
    {
        ...
        private async Task GetAuthorsAsync()
        {
            ...
            page.SkipCount =10;
            page.MaxResultCount = 100;
            page.Sorting = "";
            page.MaxResultCount = 100;
            var temp=await BookAppService.GetList1Async(page, new CreateUpdateBookDto { Name = "test"});
            var temp1=await BookAppService.GetList2Async(new CreateUpdateBookDto { Name = "test" }, page);
